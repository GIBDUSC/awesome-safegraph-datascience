...
* [Convert SafeGraph geometry CSV files to ESRI Shapefile (.shp) format -- CoLab notebook](https://colab.research.google.com/drive/1XyKAsa32s7jBr2gppkbTVFNGyzwgKoVh#scrollTo=_Ia8scLCjyiU) from Eugene Chong (SafeGraph)
...
* [ODT Flow Explorer](http://gis.cas.sc.edu/GeoAnalytics/od.html). This is an interactive spatial web portal that allows you to query, aggregate, visualize, and download daily  origin-destination (OD) flows derived from SafeGraph data and Twitter data at various geographic scales (from local to global) -- from [Geoinformation and Big Data Research Laboratory at USC](http://gis.cas.sc.edu/gibd/)
----------
